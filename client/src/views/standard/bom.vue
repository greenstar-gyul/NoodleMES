            ...
            <div class="card space-y-4 p-6" style="width: 40%; height: 63vh">
                ...
                <div class="grid grid-cols-1 gap-4 mb-4">
                    <div class="flex justify-between">
                        <div>
                            <div class="font-semibold text-2xl">하위 자재 구성영역</div>
                        </div>
                ...
                <!-- 제품유형 / 사용여부 -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <LabeledDropdown v-model="search.prod_type" label="제품유형" :options="productTypeOptions" />
                    <LabeledDropdown v-model="search.unit" label="단위" :options="unitOptions" />
                </div>
                <!-- 규격 / 사용여부 -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <LabeledDropdown v-model="search.spec" label="규격" :options="specOptions" />
