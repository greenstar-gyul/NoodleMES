    ...
    <div class="card space-y-6 p-6" style="width: 45%">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <InputText v-model="eqForm.capacity" type="text" placeholder="용량 입력" class="w-full" />
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <InputText v-model="eqForm.chk_cycle" type="text" placeholder="점검주기 입력" class="w-full" />
            </div>
        </div>
        ...
        <div>
            ...
            <Textarea v-model="eqForm.remarks" placeholder="특이사항 입력" :autoResize="true" rows="4" class="w-full" />
        </div>
    </div>
</template>
...
const saveEquipment = async () => {
    try {
        ...
        const response = await axios.post('/api/eq', eqForm.value);
...
const updateEquipment = async () => {
    try {
        ...
        const response = await axios.put(`/api/eq/${eqForm.value.eq_code}`, eqForm.value);
